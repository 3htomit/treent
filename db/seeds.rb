...
file61 = URI.open('https://images.unsplash.com/photo-1499002238440-d264edd596ec?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80')
plant6.photos.attach(io: file61, filename: 'lavender1.jpg', content_type: 'image/jpg')
file62 = URI.open('https://images.unsplash.com/photo-1600759487717-62bbb608106e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80')
plant6.photos.attach(io: file62, filename: 'lavender2.jpg', content_type: 'image/jpg')
file63 = URI.open('https://images.unsplash.com/photo-1541927634837-a7d5c4892527?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80')
plant6.photos.attach(io: file63, filename: 'lavender3.jpg', content_type: 'image/jpg')
