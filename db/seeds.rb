...
plant = Plant.new(
  name: "Bonsaï",
  description: "Cet arrangement se compose d'un véritable bonsaï chinois et d’une cascade décorative coulant sur 3 pierres empilées. Il est également pourvu d’un système d’aide à l’arrosage. Cela vous aidera à prendre soin de votre bonsaï.
  ...
  <strong>Résistance au froid :</strong> Non
  <strong>Origine France Garantie :</strong> Non
  <strong>Produit destiné au tri sélectif :</strong> Non",
  day_price: 4,
  user: User.third,
  address: "Nantes"
)
...
plant = Plant.new(
  ...
  <strong>Truffaut conseille :</strong> Placez cette plante à un endroit lumineux sans soleil direct et arrosez modérémment d'avril à septembre ( une fois par semaine). Gardez au sec en hiver.
  <strong>Truffaut informe :</strong> Maintenez toute l'année une température comprise entre 15°C et 22°C
